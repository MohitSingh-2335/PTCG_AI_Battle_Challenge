...
def agent(obs_dict: dict) -> list[int]:
    ...
    is_crustle_threat = any(cid in (344, 345) for cid in op_all_seen)
        ...
        for o in options:
            ...
            if o.type == OptionType.NUMBER:
                ...
                if atk is not None:
                    ...
                    # Crustle ex-Immunity check: Mega Lopunny deals 0 to Crustle (345)
                    if active_is_mega and op_active is not None and op_active.id == CRUSTLE:
                        effective_damage = 0
                    ...
                    if op_active and op_active.hp <= effective_damage and effective_damage > 0:
                        ...
                        elif is_lucario_threat:
                            score += 25000  # Mega Lucario decisive KO priority
                        else:
